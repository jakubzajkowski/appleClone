...
const BuyiPad=({mobile})=>{
    ...
    const BuyMacContainer=styled.div`
        ...
        width:100%;
    `
    const text = <h1 style={{color:'black',fontWeight:'bold'}}>Shop iPad</h1>
    ...
    return <div style={{width:mobile.matches ? '100vw' : '99vw',backgroundColor:'rgb(245,245,245)'}}>
        ...
        <BuyMacContainer>
            ...
            <ShoppingProductsCarousel device='ipad' data={data} isLoading={isLoading} header={productsHeader} bg_color='rgb(247,247,247)'/>
